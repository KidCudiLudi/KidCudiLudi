...

  {
    ...
    sections: {
      ...
      coWiedziec: [
        ...
        { text: 'OFERTA – 3 serie dla psów (str. 8/18): 1) SELECT GOLD COMPLETE – zrównoważona karma dostosowana do potrzeb ZDROWYCH psów (bez szczególnych wymagań żywieniowych). 2) SELECT GOLD SPECIAL NEED – karma dla psów ze specjalnymi potrzebami żywieniowymi: obejmuje SELECT GOLD Active (dla bardzo aktywnych ruchowo psów) oraz SELECT GOLD Light (dla psów ze skłonnością do nadwagi). 3) SELECT GOLD SENSITIVE – dla psów z wrażliwym układem pokarmowym lub nietolerancjami pokarmowymi; receptury z ograniczoną liczbą składników, np. Ente & Kartoffel (kaczka i ziemniaki). Wszystkie karmy suche zawierają mięso aż do 40%.', source: 'training' },
      ],
      jakWytlumaczyc: [
      ...
      powtorka: [
        ...
        { text: 'Dostosowanie: WIELKOŚĆ (Mini/Medium/Maxi) + WIEK (Junior/Adult/Senior) + WYMAGANIA SPECJALNE.', source: 'training' },
