...

  {
    ...
    sections: {
      ...
      coWiedziec: [
        ...
        { text: 'MultiFit Öko-Comfort – żwirek zbrylający, BIODEGRADOWALNY; naturalny żwirek w 100% z włókien roślinnych; zdolność pochłaniania płynów odpowiadających nawet 500% jego własnej wagi (!); doskonale neutralizuje przykre zapachy; wyjątkowo chłonny. Ekologiczna alternatywa dla bentonitu.', source: 'training' },
        ...
        { text: 'MultiFit diamonds – żwirek SILIKATOWY; wyjątkowo lekki; doskonale wiąże płyny i neutralizuje zapachy; W 100% naturalny – biodegradowalny.', source: 'training' },
        { text: 'MultiFit diamonds comfort – żwirek silikatowy; wyjątkowo lekki; doskonale wiąże płyny i neutralizuje zapachy; W 100% naturalny – biodegradowalny. (wariant comfort serii diamonds)', source: 'training' },
        { text: 'MultiFit diamonds Aloe Vera – żwirek silikatowy; o zapachu Aloe Vera; wyjątkowo lekki; doskonale wiąże płyny i neutralizuje zapachy.', source: 'training' },
        ...
        { text: 'REAL NATURE Original Naturstreu Klumpend – Weizen (pszenica): naturalny żwirek zbrylający ze 100% pszenicy (reines Weizen-Endosperm = czyste bielmo pszenne); niskopyłowy (Staubarm); naturalny zapach pszenicy (Natürlicher Weizenduft); roślinne włókna; biodegradowalny. Cena ok. 44,99 zł / 9,7 kg.', source: 'training' },
        { text: 'REAL NATURE Sensitive Naturstreu Klumpend – Maniok (maniok / kasawa): naturalny żwirek zbrylający z manioku; niskopyłowy; doskonałe właściwości zbrylające (Perfekte Klumpbildung); linia Sensitive (niebieskie opakowanie) → dla kotów wrażliwych; roślinne włókna; biodegradowalny.', source: 'training' },
      ...
      jakWytlumaczyc: [
        ...
        { text: 'Klient: "Czym różni się silikatowy od zbrylającego?" — Doradca: "Zbrylający (bentonit) tworzy twardą bryłkę, którą łatwo usunąć łopatką, wymieniasz cały żwirek raz na 2–4 tygodnie. Silikatowy (kryształki) wchłania wilgoć w kryształki i neutralizuje zapachy do kilku tygodni bez częstej wymiany – nie usuwasz bryłek, wymieniasz całość rzadko. Jest lżejszy i nie pylący, ale droższy."', source: 'extra' },
