...
const NOTES = [
...

  {
    ...
    category: 'Koty',
    tags: ['koty', 'żwirek', 'toaleta', 'PREMIERE', 'MultiFit', 'Cat\'s Best', 'zbrylający', 'silikatowy', 'higieniczny', 'długowłose', 'alergia'],
    updated: '2026-07-06',
    sections: {
      ostrzezenia: [
      ...
      coWiedziec: [
        ...
        { text: 'MultiFit diamonds comfort – żwirek silikatowy; wyjątkowo lekki; doskonale wiąże płyny i neutralizuje zapachy; TYLKO DO OTWARTYCH KUWET.', source: 'training' },
