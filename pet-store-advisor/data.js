...
const NOTES = [
...

  {
    ...
    category: 'Gryzonie i ptaki',
    tags: ['gryzonie', 'królik', 'ściółka', 'podłoże', 'MultiFit', 'Safebed', 'REAL NATURE', 'małe zwierzęta', 'gniazdo', 'świnka morska'],
    updated: '2026-07-06',
    sections: {
      ostrzezenia: [
      ...
      najwazniejsze: [
        ...
        { text: 'Dwa typy ściółek uzupełniających w ofercie Maxi Zoo: 1) Naturalne materiały roślinne (słoma, kora, las iglasty) – estetyczne, naturalne, głównie dekoracja i wzbogacenie środowiska. 2) Miękkie materiały do gniazdowania (bawełna, papier) – ciepłe, miękkie, idealne do budowy gniazda.', source: 'training' },
      ],
      coWiedziec: [
