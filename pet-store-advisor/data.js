...

  {
    ...
    sections: {
      ...
      coWiedziec: [
        ...
        { text: 'OFERTA – 3 serie dla psów: SELECT GOLD COMPLETE (karma pełnoporcjowa dla zdrowych psów bez szczególnych wymagań), SELECT GOLD SPECIAL NEED (specjalne potrzeby, np. Active dla psów aktywnych), SELECT GOLD SENSITIVE (dla psów z wrażliwym układem pokarmowym lub nietolerancjami). Wszystkie karmy suche zawierają mięso aż do 40%.', source: 'training' },
      ],
      jakWytlumaczyc: [
        ...
        { text: 'Klient: "Mój pies ma problemy z trawieniem" — Doradca: "Polecam SELECT GOLD Sensitive – to linia dedykowana psom z wrażliwym układem pokarmowym lub nietolerancjami. SELECT GOLD to Super Premium, które wspiera zdrowie psa przez codzienną rację karmy."', source: 'extra' },
      ],
      pytania: [
      ...
      powtorka: [
        ...
        { text: '3 serie: Complete (standardowa), Special Need (np. Active), Sensitive (wrażliwy żołądek/nietolerancje).', source: 'training' },
