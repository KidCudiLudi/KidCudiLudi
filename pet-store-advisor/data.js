...

  {
    ...
    sections: {
      ...
      powtorka: [
        ...
        { text: 'Sierść kręcona (Pudel, Biszony): nie linieje, ale nieustannie rośnie i kołtuni → strzyżenie co 3 miesiące u fryzjera. Szczotka druciana soft (twarde długie zęby) do regularnego czesania. Na uszy: grzebień z obrotowymi zębami (długie zęby, szeroki rozstaw).', source: 'training' },
