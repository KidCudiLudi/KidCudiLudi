...
const NOTES = [
...

  {
    ...
    sections: {
      ...
      kartaProduktu: null,
      zapamietaj: [
        { text: 'SELECT GOLD to "argument cenowy" dla klientów znających marki Super Premium – ta sama jakość co Royal Canin/Hill\'s, ale marka własna = niższa cena. To klucz do konwersji klientów premium. Kurs 18 stron – strony 1–8 opracowane; strony 9–18 do uzupełnienia po kolejnych zdjęciach szkolenia.', source: 'training' },
      ],
    },
  },
];
