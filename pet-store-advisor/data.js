...

  {
    ...
    sections: {
      ostrzezenia: [
        ...
        { level: 'red', text: 'TRYMOWANIE ≠ STRZYŻENIE u szorstkowłosych. Klient prosi o szczotkę do Schnaucera/Jamnika i mówi "strzyżą go" – zapytaj: "Czy strzyżą go maszynką, czy trymują?" Strzyżenie maszynką niszczy strukturę sierści szorstkiej, blakną kolory, włos traci wodoodporność. Właściwe to TRYMOWANIE – wyskubywanie. Nie bać się o tym mówić.' },
        { level: 'red', text: 'FILCAK DO KOŁTUNÓW TAKE CARE (10 haczyków): NIE do codziennej pielęgnacji. TYLKO do kołtunów, TYLKO w kierunku wzrostu sierści. Nieprawidłowe stosowanie = ryzyko obrażeń.' },
        { level: 'red', text: 'Sierść kręcona – kąpanie: KONIECZNIE przed strzyżeniem (równomierne opadanie włosów, ochrona ostrzy). Ale NIE częściej niż konieczne – nadmierne kąpanie szkodliwe dla skóry.' },
        { level: 'yellow', text: 'Szczotka MORE soft: CZARNA strona = kołtuny (profesjonalne, NIE codziennie). MIĘTOWA strona = codzienna pielęgnacja. Nie mylić zastosowania stron!' },
      ],
      najwazniejsze: [
      ...
      coWiedziec: [
        ...
        { text: '--- PRODUKT: Grzebień do sierści TAKE CARE (czarny, sierść szorstka) ---', source: 'training' },
        { text: 'Grzebień do sierści TAKE CARE – do usuwania martwego podszerstka i rozczesywania kołtunów. Dla kotów i psów, szczególnie zwierząt o długiej sierści. Stal nierdzewna. Zaokrąglone zęby sięgają po cebulki włosów. Ergonomicznie ukształtowana rączka = optymalny chwyt. (To jest czarny grzebień TAKE CARE – inny niż drewniany grzebień do podszerstka z brązową rączką FSC.)', source: 'training' },
        { text: '--- PRODUKT: Samoczyszcząca szczotka pielęgnacyjna TAKE CARE L ---', source: 'training' },
        { text: 'Samoczyszcząca szczotka pielęgnacyjna TAKE CARE L – uwalnia sierść od wypadających włosów, brudu i ciał obcych. Do codziennej pielęgnacji psów i kotów o krótkiej i długiej sierści. Miękkie końcówki z tworzywa sztucznego = dodatkowy efekt masażu. SAMOCZYSZCZĄCA: po pielęgnacji nacisnąć przycisk czyszczący → natychmiastowe usunięcie zebranych włosów. Ergonomiczna rączka. Uchwyt na rączce umożliwia wieszanie szczotki.', source: 'training' },
        { text: '--- KLUCZOWA RÓŻNICA: Trymowanie kontra strzyżenie ---', source: 'training' },
        { text: 'TRYMOWANIE ≠ STRZYŻENIE. Strzyżenie = tylko przycinanie włosów do równej długości, stara sierść NIE jest usuwana. U ras szorstkowłosych regularne strzyżenie (zamiast trymowania): 1) Zanika żądana szorstka struktura sierści. 2) Kolory sierści bledną (obcięte zabarwione końcówki). 3) Nowe włosy nie mogą rosnąć z tą samą grubością. 4) Zwierzę traci naturalną ochronę przed warunkami atmosferycznymi – podszerstek nie jest pokryty włosem okrywowym chroniącym przed deszczem i wiatrem → sierść podczas deszczu cała nasiąka wodą.', source: 'training' },
        { text: '--- PRODUKT: Filcak do kołtunów TAKE CARE ---', source: 'training' },
        { text: 'Filcak do kołtunów TAKE CARE – rozplątuje sierść, usuwa martwe włosy i przerzedza podszerstek szybko i efektywnie. Dla kotów i psów o długiej sierści. 10 haczyków z wysokiej jakości stali nierdzewnej – ostre jak brzytwa, bezbolesne rozczesywanie kołtunów. Zaokrąglone haczyki = bezpieczeństwo podczas stosowania. Żelowy uchwyt. UWAGA: nie do codziennej pielęgnacji – TYLKO do kołtunów. Przesuwać w kierunku wzrostu sierści.', source: 'training' },
        { text: '--- PIELĘGNACJA SIERŚCI GŁADKIEJ ---', source: 'training' },
        { text: 'Sierść psów gładkowłosych (Cocker, Yorkie, Maltańczyk, Seter, Chart afgański) najbardziej przypomina ludzkie włosy i ma podobne wymagania pielęgnacyjne. Każda warstwa sierści musi być rozplątana osobno – "powierzchowne przeczysanie" od zewnątrz tylko zakrywa kołtuny i węzły, nie usuwa ich. Do szczególnie długich partii sierści (np. uszy): grzebień z obrotowymi zębami. Używane są też odpowiednie szczotki ze stalowymi igłami lub włosiem naturalnym.', source: 'training' },
        { text: 'WSKAZÓWKA sierść gładka: Czesanie i szczotkowanie psów gładkowłosych jest zwykle łatwiejsze i delikatniejsze po kąpieli, szczególnie gdy sierść jest jeszcze nieco wilgotna.', source: 'training' },
        { text: '--- PRODUKT: Szczotka do podszerstka TAKE CARE (drewniana/brązowa) ---', source: 'training' },
        { text: 'Szczotka do podszerstka TAKE CARE – igły nylonowe + włosie naturalne. Do dokładnego szczotkowania i usuwania lekkich sfilcowań. Usuwa kurz i martwe włosy, zapewnia jedwabisty połysk. Uniwersalna – do wszystkich rodzajów sierści; szczególnie polecana do codziennej pielęgnacji psów średnich i dużych o sierści średniej długości. Drewno bukowe z certyfikatem FSC.', source: 'training' },
        { text: '--- PRODUKT: Szczotka pielęgnacyjna TAKE CARE 2w1 (czarna) ---', source: 'training' },
        { text: 'Szczotka pielęgnacyjna TAKE CARE 2w1 – łączy dwa narzędzia. Przód: zaokrąglone igły ze stali nierdzewnej = delikatna pielęgnacja podszerstka. Tył: włosie naturalne = zapobiega elektryzowaniu sierści (antystatyczna). Delikatnie usuwa martwe włosy i zapobiega ponownemu kołtunieniu. Elastyczna część ugina się pod naciskiem = komfort pielęgnacji. Dla kotów i psów, wszystkie typy sierści. Stal nierdzewna + włosie naturalne.', source: 'training' },
        { text: '--- SIERŚĆ GŁADKA: Filcak do kołtunów i degażówka + nożyczki ---', source: 'training' },
        { text: 'Sierść gładka kołtuni się szybko jeśli nie jest regularnie pielęgnowana – u niektórych psów nawet codziennie. Kołtuny rozczesywać FILCAKIEM DO KOŁTUNÓW. DEGAŻÓWKI (nożyczki filcujące): pomocne gdy całe partie sierści (np. pod przednimi nogami, za uszami) muszą zostać usunięte ze względu na skołtunienia → wyrównują przejścia między krótką a długą sierścią.', source: 'training' },
        { text: 'NOŻYCZKI (sierść gładka): do skracania wystających włosów na łapach lub konturowania (np. ogon) → dopełnienie zestawu pielęgnacyjnego dla psów gładkowłosych.', source: 'training' },
        { text: '--- PRODUKT: Degażówka TAKE CARE ---', source: 'training' },
        { text: 'Degażówka TAKE CARE – do przerzedzania obszarów z długą sierścią. Gęsta sierść może zostać łatwo przerzedzona BEZ tworzenia brzydkich stopni między długą a krótką sierścią. Zaokrąglone końcówki = bezpieczne i łatwe przerzedzanie, zmniejszone ryzyko uszkodzenia skóry. Dla psów i kotów. Gumowe pierścienie można zdjąć. OSTRZEŻENIE: nożyczki podczas pielęgnacji = ryzyko obrażeń (zwierzę może się nagle poruszyć). Używać zgodnie z profesjonalną instrukcją, ćwiczyć stosowanie.', source: 'training' },
        { text: '--- PIELĘGNACJA SIERŚCI KRĘCONEJ ---', source: 'training' },
        { text: 'Psy o sierści kręconej (pudel, biszony kędzierzawy) nie tracą włosów – komfort dla właściciela. Jednak ich sierść nieustannie rośnie i się kołtuni, dlatego muszą być regularnie strzyżone. Właściciele co 3 miesiące powinni powierzyć psa kompetentnemu psiemu fryzjerowi lub nauczyć się samemu strzyc.', source: 'training' },
        { text: 'Szczotka soft (sierść kręcona): Profesjonalnie ostrzyżony pies o kręconej sierści powinien być regularnie czesany SZCZOTKĄ DRUCIANĄ SOFT z twardymi i długimi zębami. Do długich włosów (np. uszy): grzebień do sierści najlepiej z obrotowymi zębami. Grzebień powinien mieć długie zęby i średni lub szeroki rozstaw.', source: 'training' },
        { text: 'DLACZEGO KĄPAĆ? (sierść kręcona): Psa o kręconej sierści KONIECZNIE wykąpać i wysuszyć przed strzyżeniem. Powody: 1) Włosy bardziej równomiernie opadają po kąpieli. 2) U niewykąpanych psów drobinki brudu zbyt szybko stępią ostrza nożyczek. UWAGA: Psów o kręconej sierści nie należy kąpać CZĘŚCIEJ, niż jest to konieczne – nadmierne kąpanie jest szkodliwe dla ich skóry.', source: 'training' },
        { text: '--- PRODUKT: Szczotka MORE soft ---', source: 'training' },
        { text: 'Szczotka MORE soft – szczotka wysokiej jakości, dwie funkcje w jednym. Dla zwierząt o puszystej sierści. STRONA MIĘTOWO-ZIELONA: delikatne, ale sprawne codzienne szczotkowanie. STRONA CZARNA: do profesjonalnego usuwania kołtunów – NIE jest przeznaczona do codziennego stosowania. Elastyczna główka amortyzuje pociągnięcia szczotką.', source: 'training' },
        { text: 'Degażówka (sierść kręcona): zwykłe nożyczki oraz degażówki potrzebne do przycinania przejść między częściami ciała o różnej długości sierści (np. tułów vs nogi).', source: 'training' },
      ...
      powtorka: [
        ...
        { text: 'Sierść szorstka: Trymowanie (wyskubywanie) 4x/rok u profesjonalisty lub samodzielnie po nauce. Deshedder na co dzień. Grzebień (rzadkie zęby!) do brody/brwi/nóg. Szczotka pielęgnacyjna TAKE CARE L (samoczyszcząca, przycisk!) do brody i nóg.', source: 'training' },
        { text: 'Trymowanie ≠ Strzyżenie: strzyżenie niszczy u szorstkowłosych strukturę, kolory i wodoodporność sierści. Filcak do kołtunów: 10 haczyków, stal, TYLKO na kołtuny, w kierunku wzrostu.', source: 'training' },
        { text: 'Sierść gładka: każda warstwa osobno, powierzchowne czesanie zakrywa kołtuny. Po kąpieli (wilgotna) = łatwiejsze. Grzebień z obrotowymi zębami na uszy. Kołtuny → filcak + degażówki (wyrównanie przejść). Nożyczki: łapy + konturowanie.', source: 'training' },
        { text: 'Szczotka do podszerstka TAKE CARE (drewniana FSC): igły nylonowe + włosie, sfilcowania, jedwabisty połysk, średnie/duże psy, sierść średniej długości. Szczotka pielęgnacyjna TAKE CARE 2w1 (czarna): igły stalowe (podszerstek) + włosie naturalne (antystatyczna), elastyczna.', source: 'training' },
        { text: 'Degażówka TAKE CARE: przerzedza długą sierść bez stopni między długą a krótką; zaokrąglone końcówki; psy i koty; nożyczki = ryzyko obrażeń, ćwiczyć.', source: 'training' },
        { text: 'Sierść kręcona (Pudel, Biszony): nie linieje, ale nieustannie rośnie i kołtuni → strzyżenie co 3 miesiące u fryzjera. PRZED strzyżeniem: kąpiel + suszenie (równomierne opadanie + oszczędność ostrzy). NIE kąpać za często – szkodliwe dla skóry.', source: 'training' },
